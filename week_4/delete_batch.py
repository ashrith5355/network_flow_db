...
def delete_data_from_csv_batched(csv_file, batch_size=100):
    ...
    with open(csv_file, 'r') as file:
        ...
        for row in csv_reader:
            ...
            if batch_data:
                ...
                query = f"DELETE FROM Network1000000 WHERE {where_clause}"
...
if operation == "delete":
    csv_file = "data_1000_delete.csv"  # Change this line to the new CSV file name
    delete_data_from_csv_batched(csv_file, batch_size=100)
else:
