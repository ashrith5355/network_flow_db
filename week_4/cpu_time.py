...
def insert_data_from_csv(csv_file):
    ...
    with open(csv_file, 'r') as file:
        ...
        for row in csv_reader:
            ...
            cursor.execute("INSERT INTO Network100 (scr_ip, des_ip, scr_port, des_port, ip_version) VALUES (%s, %s, %s, %s, %s)",
...
def update_data():
    ...
    cursor.execute("UPDATE Network100 SET ip_version = 'IPv6' WHERE ip_version = 'IPv4'")
    conn.commit()
...
def delete_data():
    ...
    cursor.execute("DELETE FROM Network100")
    conn.commit()
